...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/tmp/builder-jenkins/rsdk-6.5.0-3222/release/rsdk-6.5.0/linux/uclibc/mips-linux-uclibc/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/tmp/builder-jenkins/rsdk-6.5.0-3222/release/rsdk-6.5.0/linux/uclibc/mips-linux-uclibc/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
