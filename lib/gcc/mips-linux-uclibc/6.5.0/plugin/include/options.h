...
enum opt_code
{
  ...
  OPT_mlra = 1259,                           /* -mlra */
  OPT_mmac16 = 1260,                         /* -mmac16 */
  OPT_mmac32 = 1261,                         /* -mmac32 */
  OPT_mmad = 1262,                           /* -mmad */
  OPT_mmcount_ra_address = 1263,             /* -mmcount-ra-address */
  OPT_mmcu = 1264,                           /* -mmcu */
  OPT_mmemcpy = 1265,                        /* -mmemcpy */
  OPT_mmicromips = 1266,                     /* -mmicromips */
  OPT_mmt = 1267,                            /* -mmt */
  OPT_mmusl = 1268,                          /* -mmusl */
  OPT_mnan_ = 1269,                          /* -mnan= */
  OPT_mno_data_in_code = 1270,               /* -mno-data-in-code */
  OPT_mno_float = 1271,                      /* -mno-float */
  OPT_mno_flush_func = 1272,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1273,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1274,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1275,                     /* -mno-mips3d */
  OPT_modd_spreg = 1276,                     /* -modd-spreg */
  OPT_mpaired_single = 1277,                 /* -mpaired-single */
  OPT_mplt = 1278,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1279,           /* -mr10k-cache-barrier= */
  OPT_mradiax = 1280,                        /* -mradiax */
  OPT_mrelax_pic_calls = 1281,               /* -mrelax-pic-calls */
  OPT_msave_restore_mmd = 1282,              /* -msave-restore-mmd */
  OPT_mshared = 1283,                        /* -mshared */
  OPT_msimd = 1284,                          /* -msimd */
  OPT_msingle_float = 1285,                  /* -msingle-float */
  OPT_msmartmips = 1286,                     /* -msmartmips */
  OPT_msoft_float = 1287,                    /* -msoft-float */
  OPT_msplit_addresses = 1288,               /* -msplit-addresses */
  OPT_msym32 = 1289,                         /* -msym32 */
  OPT_msynci = 1290,                         /* -msynci */
  OPT_mtune_ = 1291,                         /* -mtune= */
  OPT_muclibc = 1292,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1293,        /* -muninit-const-in-rodata */
  OPT_munsafe_zero_overhead = 1294,          /* -munsafe-zero-overhead */
  OPT_mvirt = 1295,                          /* -mvirt */
  OPT_mvr4130_align = 1296,                  /* -mvr4130-align */
  OPT_mxgot = 1297,                          /* -mxgot */
  OPT_mxpa = 1298,                           /* -mxpa */
  OPT_mzero_overhead = 1299,                 /* -mzero-overhead */
  OPT_n = 1300,                              /* -n */
  OPT_no_canonical_prefixes = 1301,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1302,              /* -no-integrated-cpp */
  OPT_no_pie = 1303,                         /* -no-pie */
  OPT_noasmopt = 1304,                       /* -noasmopt */
